...
| C1-final | A (BOTH, minimal prefix 394–787) | prefix 394–787 | 25 | | automated success rate |
...
C1-lang failed 0/5 — language-only patching insufficient for cross-pair flip (consistent with Phase 1 and Phase 2a findings). C1-img also failed 0/5, so the Phase 2a image region `294-587` is not sufficient for the harder both-object-and-destination Pair A flip. C1-full passed 5/5, so cross-pair patching is possible via broader prefix KV. Binary half 0–393 failed 0/10; binary half 394–787 recovered 3/10. Both children of 394–787 failed (394–590 = 0/10, 591–787 = 0/10), so 394–787 is the smallest defensible contiguous C1 region and is being promoted to N=25. All C2 and Pair D rows pending.
...
**Last updated:** 2026-05-06 — C1 binary children under 394–787 both failed; promoting 394–787 to N=25.

**Current state:** Phase 2a and 2b complete. Phase 2c Pair A C1-lang failed 0/5, C1-img failed 0/5, and C1-full passed 5/5. Binary search found 394–787 as the smallest defensible contiguous C1 region because it recovered 3/10 while both children failed 0/10. The previous `0_PHASE2C_FAILURE.txt` is superseded by this result and should be removed or overwritten when final Phase 2c signaling is written.

**Next action:** Run C1-final positions 394–787, N=25. Record C1_MINIMAL_POSITIONS=`394-787`, then proceed to C2-prep/C2-code if N=25 remains meaningful.
