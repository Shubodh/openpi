...
**Last updated:** 2026-05-06 — C2b-lang video-only run complete; proceeding to C2b-c1minimal.
...
**Next action:** Run C2b-c1minimal video-only with `--args.patch-positions "394-787"`.
